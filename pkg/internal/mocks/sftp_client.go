...
// SupportsStatVFS mocks base method.
func (m *MockSFTPClient) SupportsStatVFS() bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SupportsStatVFS")
	ret0, _ := ret[0].(bool)
	return ret0
}

// SupportsStatVFS indicates an expected call of SupportsStatVFS.
func (mr *MockSFTPClientMockRecorder) SupportsStatVFS() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SupportsStatVFS", reflect.TypeOf((*MockSFTPClient)(nil).SupportsStatVFS))
}
